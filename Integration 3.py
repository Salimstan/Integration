...
print("Welcome to a short survey")
print("Question 1: Was your card number... 1. Less than 5 2. equal to or greater than 5?")
choose() 
print("Question 2: Did you mention your card to anyone 1. Yes. 2. no, why would I?")
choose()
print("Question 3: Would you pefer 1. To be told a secret 2. Show me the magic?")
choose()
print("Question 4: Are you ready ? 1. Yes 2. Unfortunately, no ")
choose()
print("No matter what card you picked, you are still a joker :) .")

listA = input(" Enter the  first letter of the name of your favorite arists: ")
for name in range(len(listA)):
  print(listA +" might be the best artists ever")
print(" Sigh, If only I knew who " + listA + " was " )
streams = int(input(" How many hours a week do you listen to them ?"))
tooMuch = 6
littleBit = 2
if streams > tooMuch:
    print(" Seems like you listen to them too much ")
elif streams < tooMuch:
    print(" Maybe you should check out their other music, for some new tunes ")
print(" Thank you for your time again! ")
safe = input("Taking the right precautions for COVID ? 1. yes or 2. no ? ")
if safe == 1:
    print("Continue to stay home for those who cant!" )
else:
    print("Be smart, do the right thing so we can be outide again")
